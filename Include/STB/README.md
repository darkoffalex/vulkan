...
--------------------- | ---- | -------- | --- | --------------------------------
**[stb_vorbis.c](stb_vorbis.c)** | 1.14 | audio | 5462 | decode ogg vorbis files from file/memory_ to float/16-bit signed output
**[stb_image.h](stb_image.h)** | 2.19 | graphics | 7462 | image loading/decoding from file/memory_: JPG, PNG, TGA, BMP, PSD, GIF, HDR, PIC
...
and/or use more memory_. If you're already using an equivalent
