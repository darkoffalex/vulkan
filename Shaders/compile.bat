...
C:\VulkanSDK\1.2.135.0\Bin32\glslangValidator.exe -V raytrace.rgen -o raytrace.rgen.spv
C:\VulkanSDK\1.2.135.0\Bin32\glslangValidator.exe -V raytrace.rmiss -o raytrace.rmiss.spv
C:\VulkanSDK\1.2.135.0\Bin32\glslangValidator.exe -V raytrace.rchit -o raytrace.rchit.spv
