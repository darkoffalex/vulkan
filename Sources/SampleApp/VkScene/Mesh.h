...
namespace vk
{
    namespace scene
    {
        ...
        /**
         * Размер UBO буфера для статуса использования текустур
         * С учетом выравнивания stf140 на 1 флаг приходится 16 байт (массив из 5 элементов)
         */
        const size_t TEXTURES_USAGE_UBO_SIZE = 80;
